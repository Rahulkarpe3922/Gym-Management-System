...
public class ListOfMembers extends javax.swing.JFrame {
    ...
    public ListOfMembers() {
        ...
        try
        {
            ...
            while(rs.next())
            {
                model.addRow(new Object[]{rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(8),rs.getString(9),rs.getString(10),rs.getString(11)});
